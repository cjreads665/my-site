...
const About = () => {
  return (
    <div className='mt-4 flex flex-col min-h-screen justify-around'>
        <h2 className='text-5xl text-center'>im the IT guy your manager sends</h2>
        <div className='flex justify-center'>
        <img src={profilepic} alt="cool-profile-pic" className='w-[100%]' />
        </div>
        <p>
          ...
          <br />
          <br />
          He is currently working at BizPilot Financial Pvt Ltd as a Software Developer and help the organization in backend, front end and DevOps.
          <br />
          <br />
